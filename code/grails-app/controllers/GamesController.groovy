...
class GamesController {
    ...
    def index = {
        render "action: list, input parameters:  userid & title & developer & gametype"
    }
    ...
    def list = {
        ...
        def artist = request.JSON.developer
        def genres = request.JSON.gametype
        ...
        if (userid) {
            try {
                ...
                String sqlString = "select ProductID, ProductTitle, AuthorTitle, GenresTitle from TblProducts where ProductType='game'";
                if (title) {
